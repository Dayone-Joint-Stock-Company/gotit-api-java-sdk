...
public class PRODUCTSALLDETAIL {
  ...
  @javax.annotation.Nullable
  private PAGINGSCHEMA storePagination;

  public PRODUCTSALLDETAIL() {
  }

  public PRODUCTSALLDETAIL productId(@javax.annotation.Nullable Integer productId) {
  ...
  public PRODUCTSALLDETAIL productNm(@javax.annotation.Nullable String productNm) {
  ...
  public PRODUCTSALLDETAIL productImg(@javax.annotation.Nullable String productImg) {
  ...
  public PRODUCTSALLDETAIL productDesc(@javax.annotation.Nullable String productDesc) {
  ...
  public PRODUCTSALLDETAIL productShortDesc(@javax.annotation.Nullable String productShortDesc) {
  ...
  public PRODUCTSALLDETAIL terms(@javax.annotation.Nullable String terms) {
    this.terms = terms;
    return this;
  }
  ...
  public PRODUCTSALLDETAIL brandId(@javax.annotation.Nullable Integer brandId) {
  ...
  public PRODUCTSALLDETAIL brandNm(@javax.annotation.Nullable String brandNm) {
  ...
  public PRODUCTSALLDETAIL brandLogo(@javax.annotation.Nullable String brandLogo) {
  ...
  public PRODUCTSALLDETAIL brandServiceGuide(@javax.annotation.Nullable String brandServiceGuide) {
  ...
  public PRODUCTSALLDETAIL categoryId(@javax.annotation.Nullable Integer categoryId) {
  ...
  public PRODUCTSALLDETAIL categoryNm(@javax.annotation.Nullable String categoryNm) {
  ...
  public PRODUCTSALLDETAIL categoryImg(@javax.annotation.Nullable String categoryImg) {
  ...
  public PRODUCTSALLDETAIL productType(@javax.annotation.Nullable String productType) {
  ...
  public PRODUCTSALLDETAIL prices(@javax.annotation.Nullable List<PRODUCTPRICESCHEMA> prices) {
    this.prices = prices;
    return this;
  }

  public PRODUCTSALLDETAIL addPricesItem(PRODUCTPRICESCHEMA pricesItem) {
    if (this.prices == null) {
  ...
  public PRODUCTSALLDETAIL link(@javax.annotation.Nullable String link) {
    this.link = link;
    return this;
  }
  ...
  public PRODUCTSALLDETAIL storeList(@javax.annotation.Nullable List<STOREPRODUCTSCHEMA> storeList) {
    this.storeList = storeList;
    return this;
  }

  public PRODUCTSALLDETAIL addStoreListItem(STOREPRODUCTSCHEMA storeListItem) {
  ...
  public PRODUCTSALLDETAIL totalStore(@javax.annotation.Nullable Integer totalStore) {
  ...
  public PRODUCTSALLDETAIL storePagination(@javax.annotation.Nullable PAGINGSCHEMA storePagination) {
   ...
   */
  @javax.annotation.Nullable
  public PAGINGSCHEMA getStorePagination() {
    return storePagination;
  }

  public void setStorePagination(@javax.annotation.Nullable PAGINGSCHEMA storePagination) {
    this.storePagination = storePagination;
  }
  ...
  public boolean equals(Object o) {
    ...
    PRODUCTSALLDETAIL PRODUCTS_ALL_DETAIL = (PRODUCTSALLDETAIL) o;
    return Objects.equals(this.productId, PRODUCTS_ALL_DETAIL.productId) &&
        Objects.equals(this.productNm, PRODUCTS_ALL_DETAIL.productNm) &&
        Objects.equals(this.productImg, PRODUCTS_ALL_DETAIL.productImg) &&
        Objects.equals(this.productDesc, PRODUCTS_ALL_DETAIL.productDesc) &&
        Objects.equals(this.productShortDesc, PRODUCTS_ALL_DETAIL.productShortDesc) &&
        Objects.equals(this.terms, PRODUCTS_ALL_DETAIL.terms) &&
        Objects.equals(this.brandId, PRODUCTS_ALL_DETAIL.brandId) &&
        Objects.equals(this.brandNm, PRODUCTS_ALL_DETAIL.brandNm) &&
        Objects.equals(this.brandLogo, PRODUCTS_ALL_DETAIL.brandLogo) &&
        Objects.equals(this.brandServiceGuide, PRODUCTS_ALL_DETAIL.brandServiceGuide) &&
        Objects.equals(this.categoryId, PRODUCTS_ALL_DETAIL.categoryId) &&
        Objects.equals(this.categoryNm, PRODUCTS_ALL_DETAIL.categoryNm) &&
        Objects.equals(this.categoryImg, PRODUCTS_ALL_DETAIL.categoryImg) &&
        Objects.equals(this.productType, PRODUCTS_ALL_DETAIL.productType) &&
        Objects.equals(this.prices, PRODUCTS_ALL_DETAIL.prices) &&
        Objects.equals(this.link, PRODUCTS_ALL_DETAIL.link) &&
        Objects.equals(this.storeList, PRODUCTS_ALL_DETAIL.storeList) &&
        Objects.equals(this.totalStore, PRODUCTS_ALL_DETAIL.totalStore) &&
        Objects.equals(this.storePagination, PRODUCTS_ALL_DETAIL.storePagination);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(productId, productNm, productImg, productDesc, productShortDesc, terms, brandId, brandNm, brandLogo, brandServiceGuide, categoryId, categoryNm, categoryImg, productType, prices, link, storeList, totalStore, storePagination);
  }
  ...
  public String toString() {
    ...
    sb.append("class PRODUCTSALLDETAIL {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PRODUCTSALLDETAIL
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PRODUCTSALLDETAIL.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PRODUCTSALLDETAIL is not found in the empty JSON string", PRODUCTSALLDETAIL.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PRODUCTSALLDETAIL.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PRODUCTSALLDETAIL` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("storePagination") != null && !jsonObj.get("storePagination").isJsonNull()) {
        PAGINGSCHEMA.validateJsonElement(jsonObj.get("storePagination"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PRODUCTSALLDETAIL.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PRODUCTSALLDETAIL' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PRODUCTSALLDETAIL> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PRODUCTSALLDETAIL.class));

       return (TypeAdapter<T>) new TypeAdapter<PRODUCTSALLDETAIL>() {
           @Override
           public void write(JsonWriter out, PRODUCTSALLDETAIL value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PRODUCTSALLDETAIL read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PRODUCTSALLDETAIL given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PRODUCTSALLDETAIL
   * @throws IOException if the JSON string is invalid with respect to PRODUCTSALLDETAIL
   */
  public static PRODUCTSALLDETAIL fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PRODUCTSALLDETAIL.class);
  }

  /**
   * Convert an instance of PRODUCTSALLDETAIL to an JSON string
   *
   * @return JSON string
   */
