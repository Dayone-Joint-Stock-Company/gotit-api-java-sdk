...
public class BRANDDETAIL {
  ...
  public static final String SERIALIZED_NAME_BRAND_ADDR = "brandAddr";
  @SerializedName(SERIALIZED_NAME_BRAND_ADDR)
  @javax.annotation.Nullable
  ...
  public BRANDDETAIL brandId(@javax.annotation.Nullable Integer brandId) {
  ...
  public BRANDDETAIL brandNm(@javax.annotation.Nullable String brandNm) {
  ...
  public BRANDDETAIL brandAddr(@javax.annotation.Nullable String brandAddr) {
  ...
  public void setBrandAddr(@javax.annotation.Nullable String brandAddr) {
    this.brandAddr = brandAddr;
  }


  public BRANDDETAIL brandLogo(@javax.annotation.Nullable String brandLogo) {
  ...
  public BRANDDETAIL slug(@javax.annotation.Nullable String slug) {
    this.slug = slug;
    return this;
  }
  ...
  public BRANDDETAIL shortDesc(@javax.annotation.Nullable String shortDesc) {
  ...
  public BRANDDETAIL description(@javax.annotation.Nullable String description) {
  ...
  public BRANDDETAIL categoryID(@javax.annotation.Nullable List<Object> categoryID) {
    this.categoryID = categoryID;
    return this;
  }

  public BRANDDETAIL addCategoryIDItem(Object categoryIDItem) {
  ...
  public BRANDDETAIL order(@javax.annotation.Nullable Integer order) {
    this.order = order;
    return this;
  }
  ...
  public BRANDDETAIL serviceGuide(@javax.annotation.Nullable String serviceGuide) {
  ...
  public BRANDDETAIL stores(@javax.annotation.Nullable List<STORESSCHEMA> stores) {
    this.stores = stores;
    return this;
  }

  public BRANDDETAIL addStoresItem(STORESSCHEMA storesItem) {
    if (this.stores == null) {
  ...
  public BRANDDETAIL usageMethods(@javax.annotation.Nullable List<USAGEMETHODSCHEMA> usageMethods) {
    this.usageMethods = usageMethods;
    return this;
  }

  public BRANDDETAIL addUsageMethodsItem(USAGEMETHODSCHEMA usageMethodsItem) {
  ...
  public boolean equals(Object o) {
    ...
    BRANDDETAIL BRAND_DETAIL = (BRANDDETAIL) o;
    return Objects.equals(this.brandId, BRAND_DETAIL.brandId) &&
        Objects.equals(this.brandNm, BRAND_DETAIL.brandNm) &&
        Objects.equals(this.brandAddr, BRAND_DETAIL.brandAddr) &&
        Objects.equals(this.brandLogo, BRAND_DETAIL.brandLogo) &&
        Objects.equals(this.slug, BRAND_DETAIL.slug) &&
        Objects.equals(this.shortDesc, BRAND_DETAIL.shortDesc) &&
        Objects.equals(this.description, BRAND_DETAIL.description) &&
        Objects.equals(this.categoryID, BRAND_DETAIL.categoryID) &&
        Objects.equals(this.order, BRAND_DETAIL.order) &&
        Objects.equals(this.serviceGuide, BRAND_DETAIL.serviceGuide) &&
        Objects.equals(this.stores, BRAND_DETAIL.stores) &&
        Objects.equals(this.usageMethods, BRAND_DETAIL.usageMethods);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(brandId, brandNm, brandAddr, brandLogo, slug, shortDesc, description, categoryID, order, serviceGuide, stores, usageMethods);
  }
  ...
  public String toString() {
    ...
    sb.append("    brandAddr: ").append(toIndentedString(brandAddr)).append("\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BRANDDETAIL
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BRANDDETAIL.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BRANDDETAIL.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BRANDDETAIL` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("brandAddr") != null && !jsonObj.get("brandAddr").isJsonNull()) && !jsonObj.get("brandAddr").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `brandAddr` to be a primitive type in the JSON string but got `%s`", jsonObj.get("brandAddr").toString()));
      }
